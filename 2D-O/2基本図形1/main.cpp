...
bool Application::Init(int w, int h)
{
	...
	// ウィンドウ作成
	//===================================================================
	if (m_window.Create(w, h, "基本図形１", "Window") == false) {
...
void Application::Execute()
{
	...
	//===================================================================
	if (APP.Init(1280 / 2, 720 / 2) == false) {
		return;
	}
	...
	while (1)
	{
		...
		// バックバッファクリア
		D3D.GetDevContext()->ClearRenderTargetView(D3D.GetBackBuffer(), Math::Color(0.5f, 0.5f, 0.9f, 1));
		// Zバッファクリア
